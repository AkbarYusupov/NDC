      ...
      <div className={styles['about']}>
        ...
        <div className={styles['competencies']}>
          <div className={styles['competencies_left']}>
            ...
            <p className='gl_regular'>Мы разрабатываем и интегрируем сложные высоконагруженные проекты для крупного бизнеса. Наши проекты повышают продажи и упрощают жизнь людей.</p>
            <p className='gl_regular'>Мы не любим тяжеловесные интерфейсы и ядовитый дизайн, в проектах используем понятие «нетоксичности». Для нас важно, чтобы сайты говорили на одном языке с пользователем, поэтому день за днем мы создаем новую комфортную модель поведения пользователя.</p>
          </div>
